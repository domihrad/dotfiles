...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "F1", function() awful.util.spawn("betterlockscreen -l") end,
    ...
    awful.key({ modkey }, "F5", 
        function() 
            ...
            awful.spawn.with_shell("echo 1000 | sudo tee /sys/class/backlight/intel_backlight/brightness") 
        
        end,
    {description="Reduce brightness", group="awesome"}),
    ...
    {description="Increase volume 10%", group="awesome"}),
